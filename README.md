...
A game like this is a great way to build a project because you receive immediate feedback from the code that is being turned into a game. 
...
2. Navigate to the directory where you want to store the repo:
```
cd ~/projects
```
...
6. Use WASD keys to move and space for shooting